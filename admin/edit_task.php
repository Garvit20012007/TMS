...
<body>
    ...
    <div class="row" id="header">
        <div class="col-md-12">
            <h3><i class="fa fa-solid fa-list" style="padding-right: 15px;"></i>TaskSync. - Task Management System</h3>
        </div>
    </div>
    <div class="col-md-4 m-auto" style="color:aliceblue"> <br>
        <h3 style="color:aliceblue">Edit the task</h3><br>
        <?php 
            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" class="form-control" cols="50" rows="3" placeholder="Mention the task"><?php echo $row['description']; ?></textarea>
                </div>
                <div class="form-group">
